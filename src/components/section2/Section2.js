    ...
    return (
        <section className="ScienceLogic-SL1_grad2">
            <div className="ScienceLogic-grad2-sec1">
                ...
                <p>Intelligent automations rely on seamless flow of normalized
                    data within an IT estate. SL1 connects your estate together to automate multi-directional data flows and workflows.</p>
            </div>
            <div className="ScienceLogic-grad2-sec2">
                ...
                <div className="ScienceLogic-sec2-2">
                   <div className='sec2-2-1'>
                       <h3>Monitor</h3>
                       <IoIosAddCircleOutline className='plus'/><br/>
                       <FaArrowRightLong className='rigtharrow'/>
                   </div>
                   <div className='sec2-2-2'>
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1610 320">
  <path fill="#245a8c" fill-opacity="1" d="M0,320L60,320C120,320,240,320,360,293.3C480,267,600,213,720,202.7C840,192,960,224,1080,224C1200,224,1320,192,1380,176L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
</svg>
                ...
                <div className='right-con2'>
                   ...
                   <div>CMDB</div>
                   <p>PagerDuty, xMatters, Slack, MSFT Teams, ServiceNow, Cherwell</p>
                   </div>
